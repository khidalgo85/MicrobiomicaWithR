...
require("knitr")
opts_knit$set(root.dir = "~/Google Drive File Stream/Mi unidad/GitHub/Microbiomes/slides")
```
...
```{r salva o gráfico boxplot, eval= TRUE}
...
```{r plot distance2, eval= TRUE, warning= FALSE, message=FALSE, out.height="60%", fig.align="center"}
...
ggsave("02.Results/mdsdistancia.tiff", units = "in", 
       width=14, height=8, dpi=600, compression = 'lzw', pf) # Salva o gráfico na pasta de resultados em formato .tiff com as medidas desejadas e a resolução de 600 dpi.
```
]
